...
jQuery(window).scroll(function () {
    ...
    if (top > height) {
        jQuery('.navbar-fixed-top').addClass('fadeInUp mainNavFix');
        jQuery('.navbar-fixed-top').removeClass('navbar-fixed-top-re');
    } else {
        jQuery('.navbar-fixed-top').removeClass('fadeInUp mainNavFix');
